...
if(testQC){
    ...
    load10x(din = "../input/", dout = "../output/s1/", outName = experiment, testQC = testQC, removeRBC_pal = FALSE)
    message("Initial QC parameters plotted. Results are in ../output/s1/")
    ...
    seu.obj <- readRDS("../output/s3/bm_cd34_analysis_102723_res0.6_dims45_dist0.2_neigh25_S3.rds") # point to output of dataVisUMAP
    ...
    outName <-  "allCells"
    exptName <- "bm_cd34_analysis_102723"
    ...
    message("Complete: data integrated and preliminary figures generated")
