...
pseudoDEG(metaPWD = "../output/allCells/pseudoBulk/allCells_deg_metaData.csv",
          padj_cutoff = 0.05, lfcCut = 0.58, outDir = "../output/allCells/pseudoBulk/", 
          outName = outName, 
          idents.1_NAME = contrast[1], idents.2_NAME = contrast[2],
          inDir = "../output/allCells/pseudoBulk/", title = "All cells", 
          filterTerm = "^ENSCAF", addLabs = NULL, mkDir = T
)
