...
#' @param dout the desired path to put figures and processed Seurat objects. Use realtive path.
#' @param outName Short name that will be incorporated into the output files
#' @param vars.to.regress List of features or metadata slots to regress during integration of the data 
#' @param final.dims Numerical; number of variable features to use for integration and dimension reduction - default 2000
#' @param featTOexclude List of features to exlcude from integration and dimension reduction
#' @param pattern Character; suffix of the processed Seurat objects to load in
#' @param returnObj Logical; if TRUE return the integrated object
#'
#' @return An integrated Seurat object
#' @examples 
#' @export "_S2.rds"

sctIntegrate <- function(din = "../output/s1/", dout = "../output/s2/", 
...
#'
#' @param seu.obj Seurat object to dimension reduce
...
#' @param prefix Character; prefix to use. If integrated object, use "integrated_snn_res." if nont integrated use "RNA_snn_res."
#'
#' @return
#' @examples 
#' @export ".png"
